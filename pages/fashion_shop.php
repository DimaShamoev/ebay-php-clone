...
<head>
    ...
    <link rel="stylesheet" href="../css/fashion_shop.css">
            ...
            <div class="container">
                ...
                <div class="shop-body">
                    ...
                    <div class="shop-filter">
                        <ul>
                            <li><b>Type</b></li>
                            <li><a href="?category=woman">Woman Cloth</a></li>
                            <li><a href="?category=man">Man Cloth</a></li>
                            <li><a href="?category=kid">Kid Cloth</a></li>
                        </ul>
                    ...
                    <?php
                            ...
                            if ($category && isset($category_map[$category])) {
                                ...
                                $request = "SELECT * FROM products WHERE category_id IN (7, 8, 9)";
                            }
